    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                int startingIndex = Array.IndexOf(array, 1); // метод, който показва на кой индекс от масива array се намира стойността 1

                int sum = array.Sum(); // метод, който намира сумата от числата в масива array
